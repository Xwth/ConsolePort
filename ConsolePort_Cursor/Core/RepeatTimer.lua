...
---------------------------------------------------------------
---@param onTick fun()  callback invoked on each repeat tick
---@return table        timer object with Start, Stop, OnUpdate methods
...
---------------------------------------------------------------
---@param inputProxy fun(direction: string)  callback for D-pad input
---@return table  { PADDUP, PADDDOWN, PADDLEFT, PADDRIGHT } control entries
